...
- [ ] **FOUND-01**: Unified Prisma schema merges both repos (customer/clients, booking/appointments, tattoo_design/tattoo_designs, sessions, artists, auth, analytics, settings, payments, audit_logs)
...
- [ ] **FOUND-07**: All packages aligned to latest versions (Next.js 16, React 19.2, Prisma 7, Zod 4, Tailwind CSS 4)
- [ ] **FOUND-08**: Environment variable validation with Zod for all config
