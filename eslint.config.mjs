...
export default [
  // Global ignores
  // `coverage/**` is generated by `bun run test:coverage`. It is gitignored
  // but was not eslint-ignored, so running coverage locally and then lint
  // reported warnings from vitest's own lcov-report bundle. CI never hit it
  // because CI lints without generating coverage first.
