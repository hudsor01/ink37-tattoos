  ...
  return (
    ...
    >
      ...
      <div className="grid gap-1.5">
        {payload
          .filter((item): item is NonNullable<typeof item> => item !== null && item.type !== "none")
          .map((item, index) => {
  ...
  return (
    ...
    >
      {payload
        ...
        .map((item: { dataKey?: string | number; name?: string | number; value?: string | number; color?: string }) => {
