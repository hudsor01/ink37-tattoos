...
// Instagram icon SVG since it's not in lucide-react
        ...
        >
          <div className="bg-black/50 backdrop-blur-sm rounded-lg border border-white/10 shadow-xl p-6 md:p-8">
            ...
            <p className="text-silver text-sm mb-4">
              Serving the Dallas-Fort Worth metroplex from the Crowley, TX area.
            </p>
            <div className="w-full overflow-hidden rounded-lg border border-white/10">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d107068.97769824558!2d-97.39871684414063!3d32.579277400000005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x864e62bd1a3315e9%3A0xfa38c6c79a00af8f!2sCrowley%2C%20TX!5e0!3m2!1sen!2sus!4v1711800000000!5m2!1sen!2sus"
                width="100%"
                height="350"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Ink 37 Tattoos - Crowley, TX Area"
